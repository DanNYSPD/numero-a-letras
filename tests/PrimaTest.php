...
final class PrimaTest extends TestCase
{
   ...
   public function testCantidadConSeparadorComaDecimalPuntoMonedaPesosYCentimosCentavos()
   {
      ...
      $this->assertEquals(
         'CIENTO VENTIUN MILLONES TRESCIENTOS ONCE MIL TRESCIENTOS VENTIUN PESOS CON VENTIUN CENTAVOS',
         $output
      );
   }
   public function testCantidadConSeparadorComaDecimalPuntoMonedaPesosCentimosVacioYSuffix()
   {
      ...
      $this->assertEquals(
         'CIENTO VENTIUN MILLONES TRESCIENTOS ONCE MIL TRESCIENTOS VENTIUN PESOS 45/100 M.N.',
         $output
      );
   }
   ...
   public function testCantidadConSeparadorComaDecimalValorCeroPuntoMonedaPesosCentimosVacio()
   {
      ...
      $this->assertEquals(
         'CIENTO VENTIUN MILLONES TRESCIENTOS ONCE MIL TRESCIENTOS VENTIUN PESOS',
         $output
      );
   }
   public function testCantidadConSeparadorComaDecimalValorCeroPuntoMonedaPesosCentimosVacioSuffixAlways()
   {
      ...
      $this->assertEquals(
         'CIENTO VENTIUN MILLONES TRESCIENTOS ONCE MIL TRESCIENTOS VENTIUN PESOS M.N.',
         $output
      );
   }
